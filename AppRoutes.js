...
//   // Set initial route to 'Login' always
//   let initialRoute = 'Login';

//   if (isLoggedIn()) {
//     console.log("User is logged in, determining initial route");
//     const userType = getUserType();
//     console.log("User type:", userType);

//     if (userType === 'employer') {
//       // For employers, check if they're active or if they just registered
//       const isActive = isEmployerActive();
//       console.log("Is employer active:", isActive);

//       // Additional check for newly registered employers
//       const userStatus = user?.status || user?.Status || user?.accountStatus || 'unknown';
//       console.log("Employer status:", userStatus);
...
// This is the only part that is being refactored
